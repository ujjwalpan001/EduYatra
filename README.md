...
- `frontend/` — The web application (this repository), providing the user interface and client-side logic.
- `backend/` — The API and server-side logic, handling authentication, data storage, and business rules. *(Private, not shared)*
- `mobile/` — The mobile application for on-the-go access. *(Private, not shared)*

## Backend & Mobile App Notice
